...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				...
				<form action="handle-reservation" method="post">
					...
					<div class="form-group">
						<label for="date">Date of Journey:</label> <input type="date"
					...
					<div class="form-group">
						<label for="numberOfSeats">Number of Seats:</label> <input
							...
							name="numberOfSeats" placeholder="Enter number of seats" required>
					</div>
					<div class="form-group">
		...
		<div class="container text-center">
			<form action="${pageContext.request.contextPath}/listofreservations"
				method="get">
